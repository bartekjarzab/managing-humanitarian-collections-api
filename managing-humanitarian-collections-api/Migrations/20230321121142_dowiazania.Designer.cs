...
namespace managing_humanitarian_collections_api.Migrations
{
    ...
    [Migration("20230321121142_dowiazania")]
    partial class dowiazania
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("managing_humanitarian_collections_api.Entities.OrderProduct", b =>
                {
                    b.HasOne("managing_humanitarian_collections_api.Entities.CollectionProduct", null)
                        .WithOne("OrderProduct")
                        .HasForeignKey("managing_humanitarian_collections_api.Entities.OrderProduct", "CollectionProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("managing_humanitarian_collections_api.Entities.Profile", b =>
                {
                    ...
                    b.HasOne("managing_humanitarian_collections_api.Entities.User", null)
                        .WithOne("Profile")
